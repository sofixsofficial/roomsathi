      ...
      <View key={item.id} style={styles.userCard}>
        <View style={styles.userInfo}>
          <View style={styles.userHeader}>
            ...
            <View style={[
              styles.typeBadge,
              { backgroundColor: item.userType === 'owner' ? '#22c55e' : '#3b82f6' }
            ]}>
            ...
            <View style={styles.header}>
              <View>
                ...
                <Text style={styles.headerSubtitle}>
                  RoomRent - Entire Nepal Service
                </Text>
                <Text style={styles.officeText}>
                  Office: Janakpur, Nepal
                </Text>
              </View>
        ...
        >
          ...
          <View style={styles.infoCard}>
            <Text style={styles.infoText}>
              Manage property finders and providers across entire Nepal. Block users for misuse or misconduct.
            </Text>
          </View>
