...
export default function PropertyDetailScreen() {
  ...
  const handleContactPress = () => {
    if (!isAuthenticated) {
      Alert.alert("Login Required", "Please login to contact property owners", [
        { text: "Cancel" },
        { text: "Login", onPress: () => router.push("/auth/login") },
      ]);
      return;
  ...
  const handleCallPress = async () => {
    if (!isAuthenticated) {
      Alert.alert("Login Required", "Please login to call property owners", [
        { text: "Cancel" },
        { text: "Login", onPress: () => router.push("/auth/login") },
      ]);
      return;
            ...
            try {
              if (Platform.OS === "web") {
                ...
                if (navigator.clipboard) {
                  ...
                  Alert.alert(
                    "Phone Number Copied",
                    `${property.ownerPhone} has been copied to clipboard`
                  );
                } else {
                  Alert.alert(
                    "Phone Number",
                    `Please call: ${property.ownerPhone}`
                  );
                }
              } else {
        ...
        <View ref={contentViewRef} collapsable={false}>
          ...
          <View style={styles.contentContainer}>
            <View style={styles.header}>
              ...
              <View style={styles.priceContainer}>
                <Text style={styles.price}>
                  NPR रु {property.price.toLocaleString()}
                </Text>
              ...
              <View style={styles.depositContainer}>
                ...
                <Text style={styles.depositAmount}>
                  NPR रु {property.deposit.toLocaleString()}
                </Text>
              </View>
            </View>
            ...
            <View style={styles.section}>
              ...
              {/* Temporarily disabled until Google Maps API key is configured
            {Platform.OS !== 'web' && (
              ...
              <View style={styles.ownerContainer}>
                <View style={styles.ownerInfo}>
                  ...
                  <View style={styles.ownerDetails}>
                    ...
                    <Text style={styles.ownerPhone}>
                      ☎ {property.ownerPhone || "+9779829911255"}
                    </Text>
                    <Text style={styles.ownerEmail}>
                      ✉ mail.roomrent@gmail.com
                    </Text>
                  </View>
                </View>
                <Text style={styles.ownerLocation}>
                  📍 Serving Entire Nepal
                </Text>
                ...
                <View style={styles.ownerContactActions}>
                  ...
                  >
                    ...
                    <Text
                      style={[styles.ownerActionText, { color: "#25D366" }]}
                    >
                      WhatsApp
                    </Text>
                  </TouchableOpacity>
                  ...
                  >
                    ...
                    <Text
                      style={[styles.ownerActionText, { color: "#7C3AED" }]}
                    >
                      Visit
                    </Text>
                  </TouchableOpacity>
                  ...
                  <TouchableOpacity
                    style={[
                      ...
                      styles.ownerActionButtonPrimary,
                    ]}
                  ...
                  >
                    ...
                    <Text
                      style={[styles.ownerActionText, { color: Colors.white }]}
                    >
                      Message
                    </Text>
                  </TouchableOpacity>
